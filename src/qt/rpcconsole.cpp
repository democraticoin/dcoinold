...
/**
 * Split Democraticoin command line into a list of arguments. Aims to emulate \c DCOIN and friends.
 *
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Democraticoin RPC console.") + "<br>" +
