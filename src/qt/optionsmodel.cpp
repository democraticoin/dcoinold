...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeDemocraticoinAmount"))
        settings.setValue("nAnonymizeDemocraticoinAmount", 1000);
    nAnonymizeDemocraticoinAmount = settings.value("nAnonymizeDemocraticoinAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeDemocraticoinAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeDemocraticoinAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeDemocraticoinAmount:
            return QVariant(nAnonymizeDemocraticoinAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeDemocraticoinAmount:
            nAnonymizeDemocraticoinAmount = value.toInt();
            settings.setValue("nAnonymizeDemocraticoinAmount", nAnonymizeDemocraticoinAmount);
            emit AnonymizeDemocraticoinAmountChanged(nAnonymizeDemocraticoinAmount);
            break;
        default:
            break;
        }
