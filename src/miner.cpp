...
void ThreadStakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("Democraticoin-miner");
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { while (true) {
        ...
        LogPrintf("Running FinancialStocksMiner with %llu transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("FinancialStocksMiner terminated\n");
        throw;
    }
}
