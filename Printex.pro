...
win32:LIBPNG_INCLUDE_PATH=C:/deps/libpng-1.6.16/include/
win32:LIBPNG_LIB_PATH=C:/deps/libpng-1.6.16/.libs
...
win32:SECP256K1_LIB_PATH=C:/deps/secp256k1/lib
...
LIBS += $$PWD/src/secp256k1/src/libsecp256k1_la-secp256k1.o
    ...
    isEmpty(SECP256K1_LIB_PATH) {
        windows:SECP256K1_LIB_PATH=C:/deps/secp256k1/lib
    }
...
isEmpty(MINIUPNPC_INCLUDE_PATH) {
    macx:MINIUPNPC_INCLUDE_PATH=/usr/local/Cellar/miniupnpc/2.0.20171102/include
    windows:MINIUPNPC_INCLUDE_PATH=C:/deps/
}

isEmpty(MINIUPNPC_LIB_PATH) {
    macx:MINIUPNPC_LIB_PATH=/usr/local/Cellar/miniupnpc/2.0.20171102/lib
    windows:MINIUPNPC_LIB_PATH=C:/deps/miniupnpc
}

isEmpty(OPENSSL_INCLUDE_PATH) {
    macx:OPENSSL_INCLUDE_PATH = /usr/local/Cellar/openssl/1.0.2m/include
    windows:OPENSSL_INCLUDE_PATH=C:/deps/openssl-1.0.1j/include
}

isEmpty(OPENSSL_LIB_PATH) {
    macx:OPENSSL_LIB_PATH = /usr/local/Cellar/openssl/1.0.2m/lib
...
macx:ICON = src/qt/res/icons/democraticoin.icns
macx:TARGET = "democraticoin-Qt"
