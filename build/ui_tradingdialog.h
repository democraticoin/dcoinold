...
public:
    ...
    QLabel *label_11;
    QLabel *DVYBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *DVYAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *DVYPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        DVYAvailableLabel = new QLabel(BuyTab);
        DVYAvailableLabel->setObjectName(QStringLiteral("DVYAvailableLabel"));
        QPalette palette1;
        ...
        DVYAvailableLabel->setPalette(palette1);
        DVYAvailableLabel->setFont(font3);
        DVYAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(DVYAvailableLabel);

        labelDVY = new QLabel(BuyTab);
        labelDVY->setObjectName(QStringLiteral("labelDVY"));
        labelDVY->setFont(font3);

        horizontalLayout->addWidget(labelDVY);
        ...
        UnitsInputDVY = new QLineEdit(BuyTab);
        UnitsInputDVY->setObjectName(QStringLiteral("UnitsInputDVY"));
        UnitsInputDVY->setMinimumSize(QSize(0, 0));
        UnitsInputDVY->setFont(font5);

        gridLayout_6->addWidget(UnitsInputDVY, 4, 9, 1, 1);
        ...
        BuyDVY = new QPushButton(BuyTab);
        BuyDVY->setObjectName(QStringLiteral("BuyDVY"));

        gridLayout_6->addWidget(BuyDVY, 7, 3, 1, 1);

        SellDVYBTN = new QPushButton(BuyTab);
        SellDVYBTN->setObjectName(QStringLiteral("SellDVYBTN"));

        gridLayout_6->addWidget(SellDVYBTN, 7, 9, 1, 1);
        ...
        DVYDemand = new QLabel(BuyTab);
        DVYDemand->setObjectName(QStringLiteral("DVYDemand"));
        QFont font6;
        font6.setPointSize(8);
        DVYDemand->setFont(font6);
        DVYDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(DVYDemand, 0, 1, 1, 5);

        DVYSupply = new QLabel(BuyTab);
        DVYSupply->setObjectName(QStringLiteral("DVYSupply"));
        DVYSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(DVYSupply, 0, 9, 1, 3);
        ...
        BittrexDVYLabel = new QLabel(tab);
        BittrexDVYLabel->setObjectName(QStringLiteral("BittrexDVYLabel"));
        QPalette palette7;
        ...
        BittrexDVYLabel->setPalette(palette7);
        BittrexDVYLabel->setFont(font7);
        BittrexDVYLabel->setAutoFillBackground(false);
        BittrexDVYLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexDVYLabel);
        ...
        DVYBalanceLabel = new QLabel(BalanceTab);
        DVYBalanceLabel->setObjectName(QStringLiteral("DVYBalanceLabel"));
        DVYBalanceLabel->setFont(font4);
        DVYBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(DVYBalanceLabel, 0, 3, 1, 1);
        ...
        DVYAvailableLabel_2 = new QLabel(BalanceTab);
        DVYAvailableLabel_2->setObjectName(QStringLiteral("DVYAvailableLabel_2"));
        DVYAvailableLabel_2->setFont(font4);
        DVYAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(DVYAvailableLabel_2, 1, 3, 1, 1);
        ...
        DVYPendingLabel = new QLabel(BalanceTab);
        DVYPendingLabel->setObjectName(QStringLiteral("DVYPendingLabel"));
        DVYPendingLabel->setFont(font4);
        DVYPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(DVYPendingLabel, 2, 3, 1, 1);
        ...
        DVYBalanceLabel->raise();
        DVYAvailableLabel_2->raise();
        DVYPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "DCOIN Available:", 0));
        DVYAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelDVY->setText(QApplication::translate("tradingDialog", " DCOIN", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "DCOIN", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "DCOIN", 0));
        ...
        BuyDVY->setText(QApplication::translate("tradingDialog", "Buy DCOIN", 0));
        SellDVYBTN->setText(QApplication::translate("tradingDialog", "Sell DCOIN", 0));
        ...
        DVYDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 DCOIN", 0));
        DVYSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 DCOIN", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in DCOIN:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "DCOIN", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "DCOIN Balance:", 0));
        BittrexDVYLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "DCOIN", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "DCOIN Balance:", 0));
        DVYBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "DCOIN Available:", 0));
        DVYAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "DCOIN Pending:", 0));
        DVYPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate DCOIN Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw DCOIN:", 0));
