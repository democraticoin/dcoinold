...
public:
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        ___qtablewidgetitem1->setText(QApplication::translate("MasternodeManager", "Protocol", 0));
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "Democraticoin Node Count:", 0));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "Democraticoin Network", 0));
        ...
        ___qtablewidgetitem7->setText(QApplication::translate("MasternodeManager", "IP/Onion", 0));
        QTableWidgetItem *___qtablewidgetitem8 = tableWidget_2->horizontalHeaderItem(2);
        ___qtablewidgetitem8->setText(QApplication::translate("MasternodeManager", "Reward %", 0));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidget_2->horizontalHeaderItem(3);
        ___qtablewidgetitem9->setText(QApplication::translate("MasternodeManager", "Reward Address", 0));
        QTableWidgetItem *___qtablewidgetitem10 = tableWidget_2->horizontalHeaderItem(4);
        ___qtablewidgetitem10->setText(QApplication::translate("MasternodeManager", "Status", 0));
